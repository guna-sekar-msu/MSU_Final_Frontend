...
import GuideLines from "./layers/GuideLines";
...
const ParentFeature = () => {
  ...
  const[ListedLayer,setListedLayer]=useState(null)
  // const[blobUrl,setBlobUrl]=useState(null);

  const [selectedLayer1, setSelectedLayer1] = useState(null); // Selected dataset layer
  const [selectedDate1, setSelectedDate1] = useState(""); // Selected date



  const [isComparisonChecked, setIsComparisonChecked] = useState(false); // Comparison checkbox state
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        <div className="flex-[5] p-2.5 relative h-[60vh] md:h-auto">
          {
            ...
            <CORSMap selectedLayer={selectedLayer}
        ...
        <div className="md:flex-1 p-5 bg-gray-200 overflow-y-auto">
          <SiteStats
            ...
            setSelectedLayer1={setSelectedLayer1}
            setSelectedDate1={setSelectedDate1}
            setSelectedDate1InParent={setSelectedDate} 
            setIsComparisonChecked={setIsComparisonChecked}
            isComparisonChecked={isComparisonChecked}
